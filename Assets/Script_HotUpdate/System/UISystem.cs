...
namespace UG20260527
{
    ...
    public class UISystem : AbstractSystem, IUISystem
    {
        ...
        // Panel 配置表
        private string uiConfigPath = "Assets/Res_HotUpdate/Config/UIConfig.asset";
        ...
        {
            // 加载 Panel配置表
            object obj = await this.GetSystem<IResourceSystem>().LoadAssetAsync<object>(uiConfigPath);
